...
img = cv2.imread("D:/IT/vscode/XULYANH/XuLyAnhNhom/data/image/14.jpg")
...
######## Upload KNN model ######################
npaClassifications = np.loadtxt("D:/IT/vscode/XULYANH/XuLyAnhNhom/classifications.txt", np.float32)
npaFlattenedImages = np.loadtxt("D:/IT/vscode/XULYANH/XuLyAnhNhom/flattened_images.txt", np.float32)
